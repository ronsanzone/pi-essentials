...
Your job is to determine whether the current implementation exactly satisfies the assigned task/spec. Focus on requirements compliance, omissions, incorrect behavior, and unrequested scope. Do not perform a general style review unless style affects a stated requirement.
